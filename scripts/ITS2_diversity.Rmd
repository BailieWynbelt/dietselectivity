...
write_csv(no_millet_vouchers_ITS2, "../outputs/no_millet_vouchers_ITS2.csv")
#It worked!
```
...
distinct_species_10 <- under_10_reads_ITS2  %>% 
  select(Species) %>%  
  distinct()
# = 211
distinct_species_25 <- under_25_reads_ITS2  %>% 
  select(Species) %>%  
  distinct()
# = 155
distinct_species_50 <- under_50_reads_ITS2  %>% 
  select(Species) %>%  
  distinct()
# = 132

ITS2_species_10_h <- log(211)
ITS2_species_25_h <- log(155)
ITS2_species_50_h <- log(132)
```
...
joined_diversity <- read_csv("../outputs/diversity_by_species_ITS2.csv")
